...
'''
This code is written by drpatelh
https://github.com/nf-core/viralrecon/blob/dev/bin/ivar_variants_to_vcf.py
    ...
    with open(FileIn) as f:
        for line in f:
            if not re.match("REGION",line):
                ...
                if REF not in ('A','C','G','T') or ALT not in ('A','C','G','T'):  # comment out INDELs
                    oline = '#'+oline
