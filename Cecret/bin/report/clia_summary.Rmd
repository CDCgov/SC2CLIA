...
colnames(sumTab) <- c("Sample.ID", 
                      ...
                      "Num.FastQC.R2", 
                      "Num.Seqyclean.Pairs", 
                      "Percent.Seqyclean.Pairs", 
                      "Depth.Post.Trim", 
                      "Coverage.Post.Trim", 
                      "Percent.Human.Reads", 
                      "Percent.SC2.Reads", 
                      "Num.iVar.Variants", 
                      "Num.BCFTools.Variants", 
                      "Num.BEDTools.Failed.Amps", 
                      "Num.SAMTools.Failed.Amps", 
                      "Num.N", 
                      "Num.Degenerate", 
                      "Num.ACTG", 
                      "Num.Total.Bases", 
...
knitr::kable(sumTab, escape = F, align = "l", format = "pandoc") %>% 
