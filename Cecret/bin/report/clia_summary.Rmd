...
elimsTab <- mutate(elimsTab,
                   Average.Depth = base::round(Average.Depth),
                   Percent.Genome.Coverage = base::round(Percent.Genome.Coverage, n = 1))
sumTab <- mutate(sumTab,
                 `%Seqclean.Pairs` = base::round(`%Seqclean.Pairs`, n = 1),
                 `%SC2.Reads` = base::round(`%SC2.Reads`, n = 1),
                 `%N` = base::round(`%N`, n = 1),
                 Mean.Depth.Coverage = base::round(Mean.Depth.Coverage, n = 1),
                 `%Reads.Mapping.SC2` = base::round(`%Reads.Mapping.SC2`, n = 1))
