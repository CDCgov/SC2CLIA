...
elimsTab <- mutate(elimsTab,
                   ...
                   Percent.Genome.Coverage = round(Percent.Genome.Coverage, n = 1))
sumTab <- mutate(sumTab,
                 `%Seqclean.Pairs` = round(`%Seqclean.Pairs`, n = 1),
                 `%SC2.Reads` = round(`%SC2.Reads`, n = 1),
                 `%N` = round(`%N`, n = 1),
                 Mean.Depth.Coverage = round(Mean.Depth.Coverage, n = 1),
                 `%Reads.Mapping.SC2` = round(`%Reads.Mapping.SC2`, n = 1))
