...
sumTab <- mutate(sumTab, 
                 Global.QC = case_when(
                                       Depth.Post.Trim < depthAfterTrimThreshold ~ "FAIL",
                                       `#FastQC.R1` < fastqcRawThreshold ~ "FAIL",
                                       `%Reads.Mapping.SC2` < perMappedReads ~ "FAIL",
                                       ORFs.Passing.QC < numORFsThreshold ~ "FAIL",
                                       Coverage.S < sGeneCovThreshold ~ "FAIL",
                                       Pangolin == "None" ~ "FAIL",
                                       Pangolin.QC == "fail" ~ "FAIL",
                                       `%N` >= perNThreshold ~ "FAIL",
                                       Percent.Ns.S >= perNThreshold ~ "FAIL",
                                       Vadr.S.ORF.Shift != sGeneFrameshiftThreshold ~ "FAIL",
                                       TRUE ~ "pass"
                 )) %>%
