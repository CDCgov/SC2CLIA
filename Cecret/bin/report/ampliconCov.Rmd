...
params:
  ...
  ampBED: "/opt/nCoV-2019.insert.bed"
  ampMinCov: 30
  ampMeanCov: 100
  ampMaxNFail: 5
  ampMinNPass: 93
...
pbFiles <- list.files(path = file.path(params$analysisDirFP, params$pacbamDir),
                      full.names = TRUE,
                      recursive = TRUE)
...
for (s in 1:nrow(cov_sum)) {
  rmarkdown::render(input = "/opt/ampliconDetailTemplate.Rmd", 
