...
Usage: orf_table.R -r <runID> -a <analysisDirFP> -b <bedFile1FP> -t <bedFile2FP> [-s <pacbamFileSuf> -p <pacbamDir> -m <minCov> -c <concensusDir> -f <consensusFileSuf> -d <meanDepthQC -l <covQC>]
config.R (-v | --version)
config.R (-h | --help)
Options:
-r <runID> --runID=<runID>                                    Run ID; string
-a <analysisDirFP> --analysisDirFP=<analysisDirFP>            Cecret output directory full path; string
-b <bedFile1FP> --bedFile1FP=<bedFile1FP>                     Bed file 1 with full path; string
-t <bedFile2FP> --bedFile2FP=<bedFile2FP>                     Bed file 2 with full path; string
